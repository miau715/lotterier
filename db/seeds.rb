...
event1 = admin.events.create(name: "一號活動", description: "嘎哩噗哩啵！")
event2 = normal_user.events.create(name: "活動二號", description: "我是活動二號")

event1.participants.create(name: "OREO")
event1.participants.create(name: "P醬")
event1.participants.create(name: "秒妙")
event2.participants.create(name: "甜不辣")
event2.participants.create(name: "豬血糕")
